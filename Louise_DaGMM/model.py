...
class DaGMM(nn.Module):
    ...
    def compute_energy(self, z, phi=None, mu=None, cov=None, size_average=True):
        ...
        det_cov = to_var(torch.detach(det_cov))
        #det_cov = to_var(torch.detach(det_cov).numpy(np.float32(np.array(det_cov))))
