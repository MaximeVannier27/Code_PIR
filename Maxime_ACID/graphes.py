...
plt.errorbar(x[:2000], loss_60[:2000], yerr=[std_loss_60[i] if (i%50==0) else 0 for i in range(len(std_loss_60))], label='Modèle 60')
plt.errorbar(x[:2000], loss_100[:2000], yerr=[std_loss_100[i] if (i%60==0) else 0 for i in range(len(std_loss_100))], label='Modèle 100')
...
plt.figure(figsize=(15,7.5),facecolor='lightgrey')
total_conso = [sum(dico_enviro_60['total_energy'])/len(dico_enviro_60["total_energy"]), sum(dico_enviro_100['total_energy'])/len(dico_enviro_100["total_energy"]), sum(dico_enviro_150['total_energy'])/len(dico_enviro_150["total_energy"]), sum(dico_enviro_200['total_energy'])/len(dico_enviro_200["total_energy"])]
