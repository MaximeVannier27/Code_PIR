...
#GRAPHES ENVIRO
x = ["DNN", "N-BAIOT", "DAGMM","ACID"]
valeurs_histo = [tanguy_enviro,remy_enviro,louise_enviro,maxime_enviro]
...
x = ["DNN", "N-BAIOT", "DAGMM","ACID"]
valeurs_histo = [tanguy_precision,remy_precision,louise_precision,maxime_precision]
